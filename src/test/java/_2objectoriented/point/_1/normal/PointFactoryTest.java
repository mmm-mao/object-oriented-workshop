...
public class PointFactoryTest {
    ...
    private final int goodsFee = 100;

    @Test
    public void _59歳_19550203_100円の場合は10ポイント() {

        PointFactory pointFactory = new PointFactory(goodsFee, "19550203");
    ...
    public void _60歳_19550202_100円の場合は20ポイント() {
        ...
        PointFactory pointFactory = new PointFactory(goodsFee, "19550202");
